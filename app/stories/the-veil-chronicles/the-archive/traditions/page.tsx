...
const archiveSections = [
  ...
  },
  {
    title: "Maps",
    description:
      "Follow the family's journey across oceans and through Louisiana with beautifully illustrated historical maps.",
    image: "/images/stories/maps/germany-map.jpg",
    href: "/stories/the-veil-chronicles/the-archive/maps",
  },
  {
    title: "Timeline",
    description:
      "Explore the chronological history of the Schexnaydre family and the events that shaped the Veil Chronicles.",
    image: "/images/stories/timeline/timeline.jpg",
  ...
  },
  {
    ...
    image: "/images/stories/traditions/traditions.jpg",
  ...
  },
  {
    ...
    image: "/images/stories/journals/journal.jpg",
