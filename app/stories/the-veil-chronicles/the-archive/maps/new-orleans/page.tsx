...
export default function NewOrleansMapPage() {
  return (
    <main className="min-h-screen bg-[#07161D] text-[#F8F4EA]">
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <p className="mt-6 text-lg leading-8 text-[#D8D3C8]">
          Explore the streets, cemeteries, gardens, and historic neighborhoods
          that play an important role throughout the Bayou Veil universe and
